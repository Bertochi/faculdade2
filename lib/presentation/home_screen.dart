...
class _HomeScreenState extends State<HomeScreen> {
  ...
  LatLng _cristoPosition = LatLng(41.890634, 12.490763);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Minha localização até o Coliseu'),
      ),
          ...
          : FlutterMap(
              ...
              children: [
                ...
                MarkerLayer(
                  markers: [
                    Marker(
                      point: _currentPosition!, //! -> null assertion operator "forçando" a conversão de um valor nulo para um valor não nulo
                      width: 80,
                      height: 80,
                      builder: (ctx) => Icon(
                        Icons.location_pin,
